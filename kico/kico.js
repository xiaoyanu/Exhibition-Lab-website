...
(function (global, setting) {
    ...
    console.log("%c 页面作者：小言u %c https://3.3123.ws","color: #fff; margin: 1em 0; padding: 5px 0; background: #3498db;","margin: 1em 0; padding: 5px 0; background: #efefef;");
    console.log("部分CSS及JS效果使用Kico Style");
})(window);